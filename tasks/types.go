...
var (
	NoWebHookURL                     = errors.New("No webhook URL set")
	FailedToSearchTerm               = errors.New("Failed to search term")
	FailedToGetCourses               = errors.New("Failed to get courses")
	UnableToBuildTermId              = errors.New("Unable to build Term Id")
	FailedToWrite                    = errors.New("Failed to write")
	TermNotFound                     = errors.New("Term not found")
	InvalidCampus                    = errors.New("Invalid campus")
	InvalidQuarter                   = errors.New("Invalid quarter")
	...
	FailedSubmittingSSOManager       = errors.New("Failed submitting SSO manager")
	FailedRegisterPostSignIn         = errors.New("Failed posting register signIn")
	FailedSubmittingSamISSO          = errors.New("Failed submitting sam isso")
	FailedSubmittingSSBSp            = errors.New("Failed submitting SSB sp")
	FailedSavingTerm                 = errors.New("Failed saving term")
	FailedGettingRegistrationStatus  = errors.New("Failed getting registration status")
	FailedVisitingClassRegistration  = errors.New("Failed visiting class registration")
	FailedGettingEvents              = errors.New("Failed getting events")
	FailedParsingDate                = errors.New("Failed parsing date")
	NotEligibleToRegister            = errors.New("Not eligible to register")
	FailedSubmittingSignupTerm       = errors.New("Failed to submit signup term")
	FailedToAddCourse                = errors.New("Failed to add course")
	FailedSubmittingChangesCRNErrors = errors.New("Failed submitting changes (CRN Errors)")
